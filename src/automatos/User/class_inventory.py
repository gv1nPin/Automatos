...
class ControlledItem:
    """Упрощённый класс для лекарственного препарата."""
    def __init__(self, item_id, name):
        self.item_id = item_id   # уникальный артикул
...
class Stock:
    ...
    """
    def __init__(self, item: ControlledItem, quantity: int, batch_or_lot: str, location_code: str):
        """
